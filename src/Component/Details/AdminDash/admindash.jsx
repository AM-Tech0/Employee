...
//   return (
//     <div className="p-6">
//       <h1 className="text-2xl font-semibold mb-4 flex justify-center text-red-500">Admin Dashboard</h1>
...
//           className="border p-2 rounded w-full max-w-md  focus:outline-none focus:border-red-500 focus:border-4"
//           value={searchTerm}
